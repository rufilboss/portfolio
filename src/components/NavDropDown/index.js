  ...
  <DropDownContainer active={props.isOpen}>
    ...
    <DropDownItem href="#" target="_blank" rel="noreferrer">
      ...
      <DropDownTextContainer>
        ...
        <DropDownItemDesc>If you want to talk to me just send a message and I'll get back to you.</DropDownItemDesc>
      </DropDownTextContainer>
    </DropDownItem>
    <DropDownItem href="#" target="_blank" rel="noreferrer">
      <DropDownIcon>
      ...
      <DropDownTextContainer>
        ...
        <DropDownItemDesc>Ibadan, Nigeria</DropDownItemDesc>
      </DropDownTextContainer>
    </DropDownItem>
  </DropDownContainer>
);
